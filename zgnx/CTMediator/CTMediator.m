...
#pragma clang diagnostic pop
    } else if ( [target respondsToSelector:NSSelectorFromString([NSString stringWithFormat:@"%@:", actionName])] ) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
        return [target performSelector:NSSelectorFromString(actionName) withObject:params];
#pragma clang diagnostic pop
    } else {
